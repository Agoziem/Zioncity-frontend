...
const ClassResultcredentials = ({handleSubmit,loadingresults,classresultcredential,setClassResultscredential,schoolsessions,schoolterms}) => {
  return (
    <div>
        <form className="row g-3" onSubmit={handleSubmit}>
            ...
            <label htmlFor="termselect" className="form-label">Term</label>
                <select id="termselect" className="form-select" value={classresultcredential.term_id}
                    onChange={(e) => setClassResultscredential({ ...classresultcredential, term_id: e.target.value })} >
                        {
            ...
            <div className="col-md-6">
                ...
                <select id="sessionselect" className="form-select" value={classresultcredential.session_id}
                    onChange={(e) => setClassResultscredential({ ...classresultcredential, session_id: e.target.value })} >
